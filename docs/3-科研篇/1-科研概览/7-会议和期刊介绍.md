...
| **ICLR** | International Conference on Learning Representations | 每年 1 次（5 月） | 相对最年轻的顶会（2013 年深度学习三巨头LeCun以及Bengio创办），以表征学习起家，现已覆盖深度学习各方向。采用 OpenReview 公开审稿，透明度高。 |
